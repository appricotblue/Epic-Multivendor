                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        /// SHOW PINCODE
                        /// SHOW LOCATION
                        checkoutProvider.addressListModel?.addressList
                                        ?.length ==
                                    0 ||
                                checkoutProvider.addressListModel?.addressList
                                        ?.length ==
                                      ...
                                      onTap: () {
                                        setState(() {
                                          ...
                                          Provider.of<CheckoutProvider>(context,
                                                  listen: false)
                                              .deliveryCalculation(context,
                                                  fromLatitude:
                                                      "${userModel.lat}",
                                                  fromLongitude:
                                                      "${userModel.lng}",
                                                  toLatitude:
                                                      "${checkoutProvider.addressListModel?.addressList?[index].latitude}",
                                                  toLongitude:
                                                      "${checkoutProvider.addressListModel?.addressList?[index].longitude}");
                                        });
                                      },
                                      child: Container(
                                  ...
                                  InkWell(
                                    onTap: () {
                                      if (postCTLR.text.isEmpty ||
                                          ...
                                          userModel.placeName == "null" ||
                                          userModel.placeName == "" ||
                                          houseNumberCTLR.text.isEmpty ||
                                          landMrakCTLR.text.isEmpty) {
                                        SnackBarMessage(
              ...
              onPressed: () {
                ...
                if (userModel.addressId == null || userModel.addressId == "") {
                  ...
                  SnackBarErrorMessage(context,
                      "No service is available between these regions.No intercity service is available.");
                } else {
                    ...
                    widget.isOrder == "true"
                        ? Provider.of<CheckoutProvider>(context, listen: false)
                            ...
                            Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const ShopOrderPlaced(),
                                ));
                          })
                        : Provider.of<CheckoutProvider>(context, listen: false)
                            .placeOrder(
