    ...
    return Consumer<SplashProvider>(
      builder: (context, value, child) =>
        ...
        appBar: AppBar(
          ...
          title: Text("Contact Us",style: Theme.of(context).textTheme.bodyText1?.copyWith(fontSize: 20,color: AppColors.white),),
        ),
        body:value.isLoading?const  SizedBox(width:25,height: 25, child: CircularProgressIndicator()): SingleChildScrollView(
          child: Padding(
            padding: const EdgeInsets.all(12.0),
            child:Provider.of<SplashProvider>(context, listen: false).settingsModel?.contactUs != null?
            HtmlWidget(
              '''
           ${Provider.of<SplashProvider>(context, listen: false).settingsModel?.contactUs} 
             ''',
