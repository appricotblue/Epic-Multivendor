...
class _ServiceListState extends State<ServiceList> {
  ...
  @override
  void initState() {
    context.read<HomeProvider>().initializeServiceListScrollController();
  ...
  // @override
  // void dispose() {
  //   context.read<HomeProvider>().scrollController.dispose();
  ...
  Widget build(BuildContext context) {
    ...
    log('ServiceList ScrollController: ${homeProvider.scrollController}');
        ...
        : Padding(
            ...
            child: ListView(
              ...
              children: [
                ...
                homeProvider.homeServiceListModel?.serviceBanners?.length ==
                            0 ||
                        homeProvider
                                .homeServiceListModel?.serviceBanners?.length ==
                            null
                    ? Container()
                    : ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          imageUrl:
                              "${ApiEndPoints.imageBaseURL}${homeProvider.homeServiceListModel?.serviceBanners?[0].imageName}",
                ...
                homeProvider.homeServiceListModel?.serviceCategories?.length ==
                            0 ||
                        homeProvider.homeServiceListModel?.serviceCategories
                                ?.length ==
                            null
                    ? Center(
                    ...
                    : Padding(
                        ...
                        child: Container(
                          ...
                          child: GridView.builder(
                            ...
                            itemCount: homeProvider.homeServiceListModel
                                ...
                                child: InkWell(
                                  onTap: () {
                                    userModel.updateWith(
                                        serviceCategoryId: homeProvider
                                            .homeServiceListModel
                                            ?.serviceCategories?[i]
                                            .id
                                            .toString(),
                                        serviceCategoryName: homeProvider
                                            .homeServiceListModel
                                            ?.serviceCategories?[i]
                                            .types,
                ...
                homeProvider.serviceslist.isEmpty
                    ? Center(
                        child: Image.asset(AppAssetsImages.noService1),
                      )
                    : GridView.builder(
                        ...
                        itemCount: homeProvider.serviceslist.length,
                        shrinkWrap: true,
                        physics: const NeverScrollableScrollPhysics(),
                        itemBuilder: (context, i) {
                          return CommonListServiceWidget(
                            image:
                                "${ApiEndPoints.imageBaseURL}${homeProvider.serviceslist[i].image}",
                            title: homeProvider.serviceslist[i].title ?? "",
                            type: homeProvider.serviceslist[i].serviceType,
                            location: homeProvider.serviceslist[i].shopLocation,
                            ratingViews: "2.4k",
                            price: homeProvider.serviceslist[i].price ?? "0",
                            iconData: homeProvider.serviceslist[i].isWishlist ==
                                    false
                                ? InkWell(
                                    onTap: () {
                            ...
                            onTap: () {
                              userModel.updateWith(
                                  serviceId: homeProvider.serviceslist[i].id
                                      .toString());
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
