...
class CommonScreenGridList extends StatefulWidget {
  CommonScreenGridList(
      {super.key,
        this.image,
        this.title,
        this.type,
  ...
  @override
  State<CommonScreenGridList> createState() => _CommonScreenGridListState();
}

class _CommonScreenGridListState extends State<CommonScreenGridList> {
  @override
